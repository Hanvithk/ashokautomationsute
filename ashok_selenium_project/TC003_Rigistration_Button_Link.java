...
public class TC003_Rigistration_Button_Link {
	...
	public void tc001() {
		...
		driver.findElement(By.xpath("//input[@value='Sign up']")).click(); // Button
		driver.findElement(By.xpath("//a[text()='Read Detail']")).click(); // Link
